...
# $group - Openstack Security Group Terraform module

This is an Openstack translation of the module "terraform-aws-modules/security-group/aws//modules/${group}"

## Usage

\`\`\`hcl
module "${group/-/_}_security_group" {
  source  = "not/yet/added/to/terraform/registry//modules/${group}"
  version = "~> 3.0"
